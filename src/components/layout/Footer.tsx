                    ...
                    <div className="md:col-span-1">
                        <FadeIn>
                            ...
                            <div className="flex gap-4">
                                ...
                                <a href={etsyUrl} target="_blank" rel="noopener noreferrer" className="h-10 w-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-[#D45305] hover:text-white transition-all text-gray-400 group/icon" onClick={() => sendGTMEvent('etsy_click', { location: 'footer_icon' })}>
                    ...
                    <div className="md:justify-self-end">
                        <FadeIn delay={0.2}>
                            ...
                            <ul className="space-y-4 text-gray-400 text-sm">
                                ...
                                <li><a href={etsyUrl} target="_blank" rel="noopener noreferrer" className="hover:text-[#C5A059] transition-colors" onClick={() => sendGTMEvent('etsy_click', { location: 'footer_links' })}>{t('links.etsy')}</a></li>
